...
productRouter.route("/get-all-products-full").get(getAllProductsFull);
productRouter.route("/get-products-by-category").post(getProductsByCategory);
productRouter
  .route("/get-products-by-category-full")
  .post(getProductsByCategoryFull);
